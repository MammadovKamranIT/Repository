...
namespace Shop.Api.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<CustomerResponseDto>>> GetById(int id)
        {
            ...
            var authorizationResult = await _authorizationService.AuthorizeAsync(User, customer, "AppUserRole");
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<CustomerResponseDto>>>> GetAll()
        {
            ...
            var projects = await _customerService.GetAllForUserAsync(userId, Roles);
            return Ok(ApiResponse<IEnumerable<CustomerResponseDto>>.SuccessResponse(projects));
        }
