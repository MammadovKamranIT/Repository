    ...
    public partial class @new : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMembers", x => new { x.CustomerId, x.UserId });
                    table.ForeignKey(
                        name: "FK_AppMembers_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppMembers_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Customers_User_OwnerId",
                table: "Customers",
                column: "OwnerId",
                principalTable: "User",
                principalColumn: "Id",
